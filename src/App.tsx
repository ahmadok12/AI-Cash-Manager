...
export default function CashApp(){
  ...
  async function saveOpening(e:FormEvent){
    ...
    if(nextBalance<0){notify(`Opening balance is too low · increase it by at least ${money(Math.abs(nextBalance))}`);return}
