  ...
  return <main className="phone-shell">
    ...
    {tab==="settings"&&<section className="screen">
      ...
      <div className="settings-group"><small>BACKUP & SYNC</small>
        <div className="setting-status"><span><Cloud/></span><div><strong>Supabase backup</strong><small>{cloudState==="saved"?"Private cloud copy is up to date":cloudState==="saving"?"Saving private cloud copy…":cloudState==="unavailable"?"Setup required · entries remain on this device":"Saved on this device"}</small></div><i className={cloudState==="saved"?"on":""}/></div>
